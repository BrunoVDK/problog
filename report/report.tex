...
%
\begin{center}
\textit{Below's our solution for the given challenges. The questions in each section of the original assignment are answered in a section with a corresponding title.}
\end{center}
...
query(smokes(a)).
\end{minted}
\captionof{listing}{\texttt{PROBLOG} code used throughout.}
\label{code:base}
\end{code}
